...
namespace MenthaAssembly.Views
{
    public class Magnifier : Control
    {
        ...
        protected virtual void OnRefreshImage()
        {
            ...
            PART_Root.Background = new ImageBrush(BitmapSource.Create(Screenshot_Width, Screenshot_Height, 96, 96, PixelFormats.Bgr24, null, Screenshot.Data0, (int)Screenshot.Stride));
        }
